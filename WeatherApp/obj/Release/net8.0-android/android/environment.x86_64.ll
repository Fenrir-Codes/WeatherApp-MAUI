...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555150, ; uint32_t android_runtime_jnienv_class_token (0x20002ce)
	i32 100670817, ; uint32_t jnienv_initialize_method_token (0x6001d61)
	i32 100670816, ; uint32_t jnienv_registerjninatives_method_token (0x6001d60)
...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1741876764596195267, ; hash 0x182c63b044434fc3, from name: aot-WeatherApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 47
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3335046864741941053, ; hash 0x2e48777422393f3d, from name: aot-WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 99
	...
	%struct.DSOCacheEntry {
		i64 5244658196496622195, ; hash 0x48c8c4d7a285a273, from name: libaot-UtcTimeLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6573685658744430043, ; hash 0x5b3a6c471a8a9ddb, from name: libaot-UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 188
	...
	%struct.DSOCacheEntry {
		i64 6802572864685204697, ; hash 0x5e6797fa9645e4d9, from name: WeatherApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 192
	...
	%struct.DSOCacheEntry {
		i64 8648369780619108611, ; hash 0x78052e7e94066103, from name: aot-UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 265
	...
	%struct.DSOCacheEntry {
		i64 10432649220714976515, ; hash 0x90c8373112f8d503, from name: libaot-WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 329
	...
	%struct.DSOCacheEntry {
		i64 12311929081493451728, ; hash 0xaadcc244aa37f3d0, from name: libaot-WeatherApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
	...
	%struct.DSOCacheEntry {
		i64 12375137271760854038, ; hash 0xabbd51c84a009c16, from name: aot-UtcTimeLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 15200466301430623149, ; hash 0xd2f2e790cd116bad, from name: WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 485
	...
	%struct.DSOCacheEntry {
		i64 16387258934251239567, ; hash 0xe36b3d2d6264388f, from name: UtcTimeLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 524
	...
	%struct.DSOCacheEntry {
		i64 17407101913273015902, ; hash 0xf19272f69da91e5e, from name: UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 552
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0aa01096-5d0a-464a-94b2-a5adef6f995e\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-WeatherApp.dll.so\00", align 16
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [29 x i8] c"libaot-UtcTimeLibrary.dll.so\00", align 16
