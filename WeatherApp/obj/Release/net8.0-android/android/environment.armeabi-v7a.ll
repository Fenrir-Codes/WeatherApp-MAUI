...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 161724104, ; hash 0x9a3b6c8, from name: libaot-WeatherApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 175567532, ; hash 0xa76f2ac, from name: UtcTimeLibrary
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1473478365, ; hash 0x57d37edd, from name: libaot-WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 196
	...
	%struct.DSOCacheEntry {
		i64 1578236931, ; hash 0x5e11fc03, from name: libaot-UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 210
	%struct.DSOCacheEntry {
		i64 1620023678, ; hash 0x608f997e, from name: WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 211
	...
	%struct.DSOCacheEntry {
		i64 2414698028, ; hash 0x8fed5e2c, from name: aot-UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 337
	...
	%struct.DSOCacheEntry {
		i64 2775026803, ; hash 0xa5678c73, from name: aot-WeatherApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 2819035555, ; hash 0xa80711a3, from name: UtcTimeLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 399
	...
	%struct.DSOCacheEntry {
		i64 3209983798, ; hash 0xbf547736, from name: libaot-UtcTimeLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 455
	...
	%struct.DSOCacheEntry {
		i64 3704645182, ; hash 0xdcd0663e, from name: aot-WeatherApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 513
	...
	%struct.DSOCacheEntry {
		i64 4045855416, ; hash 0xf126dab8, from name: aot-UtcTimeLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-UtcTimeLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 555
	...
	%struct.DSOCacheEntry {
		i64 4154415006, ; hash 0xf79f579e, from name: WeatherApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WeatherApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 570
